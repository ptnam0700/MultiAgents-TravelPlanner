...
def rag_chat_node(state):
    ...
    Returns:
        dict: Updated state with chat response and updated chat history
    """
    if not rag_chatbot:
    ...
    try:
        ...
        context_message = f"""
            ...
            Please provide helpful travel advice, especially for Vietnam travel. Use your knowledge of Vietnam's hidden gems, food culture, local insights, and practical travel tips to give comprehensive and personalized advice based on the travel context above.
        """
